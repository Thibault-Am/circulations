...
$meteo= file_get_contents("https://data.loire-atlantique.fr/explore/dataset/224400028_info-route-departementale/download?format=json&timezone=Europe/Berlin&use_labels_for_header=false",false);
var_dump($meteo);
?>
<!DOCTYPE html>
<html>
